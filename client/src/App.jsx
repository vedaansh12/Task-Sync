      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8 animate-slideIn">
          <div className="flex items-center justify-center gap-2 mb-2">
            <LayoutList className="w-10 h-10 text-purple-500" />
            <h1 className="text-5xl md:text-6xl font-bold leading-[1.2] pb-3 bg-gradient-to-r from-purple-500 to-purple-300 bg-clip-text text-transparent">
              TASK SYNC
            </h1>
          </div>
          <p className="text-purple-300/60 text-lg">Organize your tasks</p>
        </div>
        
        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="glass-card rounded-xl p-4 text-center transform transition-all duration-300 hover:scale-105 hover:border-purple-500/50">
            <LayoutList className="w-8 h-8 text-purple-500 mx-auto mb-2" />
            <div className="text-2xl font-bold text-purple-500">{totalCount}</div>
            <div className="text-purple-300/60 text-sm">Total Tasks</div>
          </div>
          
          <div className="glass-card rounded-xl p-4 text-center transform transition-all duration-300 hover:scale-105 hover:border-purple-500/50">
            <Circle className="w-8 h-8 text-purple-400 mx-auto mb-2" />
            <div className="text-2xl font-bold text-purple-400">{activeCount}</div>
            <div className="text-purple-300/60 text-sm">Active Tasks</div>
          </div>
          ...
          <div className="glass-card rounded-xl p-4 text-center transform transition-all duration-300 hover:scale-105 hover:border-purple-500/50">
            ...
            <div className="text-purple-300/60 text-sm">Completed</div>
          </div>
        </div>
        ...
        {loading ? (
          <div className="glass-card rounded-xl p-8 text-center">
            ...
            <div className="text-purple-300/60">Loading your tasks...</div>
          </div>
