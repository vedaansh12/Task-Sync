    ...
    <div className="glass-card rounded-xl overflow-hidden transition-all duration-300">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-purple-400">Add New Task</span>
        </div>
      ...
      {isExpanded && (
        <form onSubmit={handleSubmit} className="px-6 pb-6 animate-slideIn">
          ...
          <div className="mb-4">
            <label className="block text-purple-400 font-medium mb-2 text-sm">Title</label>
            <input
              type="text"
              value={title}
          ...
          <div className="mb-4">
            <label className="block text-purple-400 font-medium mb-2 text-sm flex items-center gap-2">
